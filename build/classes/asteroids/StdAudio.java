// Mason
//  S To change this license header, choose License Headers in 
// Project Properties.
...
public final class StdAudio {
    ...
    private static void init() {
        try {
            ...
            // it gets divided because we can't expect 
            // the buffered data to line up exactly with when
     ...
     * as a double array with values between -1.0 and +1.0. Note: currently only
     * monoaural files with a sample rate of 44,100 Khz are supported.
     *
    ...
    // https://www3.ntu.edu.sg/home/ehchua/programming/java/J8c_
    // PlayingSound.html
    ...
    **************************************************************************
    ...
    public static void main() {
        ...
        // need to call this in non-interactive stuff so the 
...
// Last updated: Fri Mar 1 12:30:03 EST 2019.
